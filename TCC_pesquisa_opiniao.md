...
disponível na [pasta](https://drive.google.com/drive/folders/10Zv1waT-aTPFsYhZ6l1CSa3feDEBZ1R2?usp=sharing). 

### Alguns objetivos específicos
1. Desenvolvam ao menos 200 simulações por cada modelo.
2. Comparar acuracidade (verificar métricas), distribuições das respostas e explicabilidade (importância relativa das variáveis preditoras). 
3. Incluir o maior número possível de características e respostas (sugestão: começem com um pequeno número respondentes, características e respostas, e aumente gradualmente).     

### Sobre as ferramentas
Empreguem somente modelos e recursos abertos, sendo 100% executável e aberto. Preferencialmente executar 100% em notebooks Colab. 
...
### Extra
A depender do andamento o projeto pode ser estendido adicionando-se a comparação com a simulação de respostas a partir do *fine-tunning* do modelo LLM.  
